...
void main() {
  ...
  print('Analytics aggregates totalVolume: ${analyticsDto.aggregates?.totalVolume}');
  ...
  print('Exercise Details comparison current maxWeight: ${detailsDto.comparison?.current?.maxWeight}');
