...
class MealAnalyticsDto {
  ...
  factory MealAnalyticsDto.fromJson(Map<String, dynamic> json) =>
      MealAnalyticsDto(
        period: json["period"],
        summary:
        ...
        topMeals: json["topMeals"] == null
            ? []
            : List<TopMeal>.from(
                json["topMeals"]!.map((x) => TopMeal.fromJson(x))),
...
class TopMeal {
  ...
  factory TopMeal.fromJson(Map<String, dynamic> json) => TopMeal(
        name: json["name"],
        count: json["count"],
      );
